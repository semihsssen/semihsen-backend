...
function renderG(gid,works,key){
  ...
  for(var i=0;i<works.length;i++){
    ...
    html+="<div class='gallery-item'><img src='"+url+"' onerror='imgErr(this)'><div class='g-overlay'><button class='del-btn' onclick='delWork(""+key+"","+i+",""+gid+"")'><i class='ti ti-trash'></i></button></div></div>";
  }
  g.innerHTML=html;
}
...
function renderPG(n,slides){
  ...
  for(var i=0;i<slides.length;i++){
    var s=slides[i];
    html+="<div class='gallery-item'><img src='"+s.url+"' onerror='imgErr(this)'><div class='g-overlay'><button class='del-btn' onclick='delPSlide("+n+","+i+")'><i class='ti ti-trash'></i></button></div></div>";
  }
  g.innerHTML=html;
}
